# Role Planning Report - Week 08 RxNow
...
* [**Epic Story**:](https://miro.com/app/board/uXjVHW1B9x4=/)
  As back end lead,
  I want to plan and execute the tasks associated with my roles for v3.0, online hosting has been accomplished, now fixing serious bugs is a priority. Josh got us a great testing plan and I plan to implement it on the back-end system. I have found issues already and am adding them to our issues as they come, still need to find a way to test time-based threshhold traversal to see if a notification forms.

* **Story Point/Value**: 3

* **Planned Delivery**: v3.0 — Weeks 08–09
