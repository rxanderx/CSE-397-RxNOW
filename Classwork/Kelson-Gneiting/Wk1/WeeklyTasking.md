...
[Class Meeting](..\Kelson-Gneiting\classmeetingnotes\April 21st.md)
...
## Individual Work (10 pts - 5 for [Gold](../training/CC_CareerReadiness.md), 5 for [Training](../training/))
 ...
 - [x] Professional Training
    - The 2-Hour Job Search (Week 01-03)
        Finished Part 1 [Part 1](../2hr%20Job%20Search/Part1.md)
...
<!-- 10 pts: Link to meeting minutes from team meeting-->
 - [x] Weekly Meeting with team (every week - arranged by your team) (No Meeting Week 1)
...
I worked on getting gold, transcribing meetings, and working on catching up.

* What will I do today to help meet the Sprint Goal?

Do the Research, Meet to officially get the silver (I have done everything and most of gold), and part 2 of 2 hr job search

* Do I see any impediment that prevents me or the team from meeting the Sprint Goal.

My lack of knowledge in the team areas including what the roles do and what features we are projecting
...
### What did you do yesterday to help meet the Sprint Goal? (N/A Week 1)
...
* ([Feature](../management/planning/featurePlanningReport.md) or [Role](../management/planning/rolePlanningReport.md)) and [Research](../engineering/practices/Research/Readme.md) Planning Tasking (10 pts)
    ...
    - [x] Role Planning Tasking (every even eek)[project/management/planning]
    <!-- Research Tasking
...
* [Scheduled](../management/scheduling/Readme.md) Tasking completed This week (50 pts - 10 pts per completed task)
    ...
    --> 
    - Week 1 Stories
        - [x] 1.1: **Complete Student Setup** - Setup initial environment and repository
        - [x] 1.2: **Create Staffing Dossier** - [Gneiting_dossier.md](../Gneiting_dossier.md)
        - [x] 1.3: **Create GitHub org/repo and setup class GitHub** - Initial repository configuration
        - [x] 1.4: **Initial project backlog and roles** - Define project scope and team roles

<!-- 5 pts: Links to Product tasking issues -->
* Week 2 Planning (5 pts - Role Planning Week & Elicitation Activities)
    - [ ] [Class Meeting Notes - April 28th](../classmeetingnotes/April%2028th.md)
    - [ ] [Team Meeting Notes - April 28th](../Wk2/April%2028th%20TeamMinutes.md)
    - [ ] [Gold Certification Progress](../Gold/Gneiting_CertificationReport.md)
    - [ ] [2-Hour Job Search Part 2](../2hr%20Job%20Search/Part2.md)
    - [ ] 2.1: **Brainstorming & Customer Meeting** - [Brainstorming](../Wk2/Gneiting_Brainstorming.md), [Customer Meeting](../Wk2/CustomerMtgMinutes.md)
    - [ ] 2.2: **Document Analysis** - [Document Analysis](../Wk2/Gneiting_DocAnalysis.md)
    - [ ] 2.3: **Empathy** - [Empathy](../Wk2/Gneiting_EmpathyUser.md)
    - [ ] 2.4: **Introspection** - [Introspection](../Wk2/Gneiting_Introspection.md)
    - [ ] 2.5: **Overview Analysis** - [Overview](../Wk2/ProjectModel.md)
    - [ ] 2.6: **Quality Model** - [Quality Model](../Wk2/Gneiting_QualityModel.md)
