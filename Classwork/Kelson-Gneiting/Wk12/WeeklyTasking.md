...
* **Labels**: week-12, scrum-master, responsible-engineer, gold-cert, ethics, rxnow-mvp
...
## Training/Class Meeting [Minutes](../management/meetingminutes/Readme.md)(05 pts)
 - [x] Training/Class Meeting - Training Notes (every week via zoom): [July 7 Class Meeting Notes](../../../Classwork/Class-Notes/July-7.md)
...
## Individual Work (10 pts - 5 for [Gold](../training/CC_CareerReadiness.md), 5 for [Training](../training/))
 - [x] Professional Networking Certification: Career Services Gold Certificate (every week): [Gold Certification Report](../Gold/Gneiting_CertificationReport.md)
     ...
     - Career mentor appointment: [New Appointment | Handshake](https://byui.joinhandshake.com/stu/appointments/new)
 - [ ] Professional Training
        - The 2-Hour Job Search (Week 01-03)
        - Job Search (Week 04-05)
        - AWS Modules: Cloud Fundamentals (Week 06-11)
        - Ethics (Week 12-14) - started this week
...
Fufulled my role, met with team, and worked on gold

* What will I do today to help meet the Sprint Goal?

Catch up on old weeks and present project/ get it ready for next group
...
* ([Feature](../management/planning/featurePlanningReport.md) or [Role](../management/planning/rolePlanningReport.md)) and [Research](../engineering/practices/Research/Readme.md) Planning Tasking (10 pts)
    ...
    - [x] Role Planning Tasking (every even eek)[project/management/planning]: [Week 12 Role Report](./RoleReport.md)
    <!-- Research Tasking
...
* [Scheduled](../management/scheduling/Readme.md) Tasking completed This week (50 pts - 10 pts per completed task)
    ...
    - [Role](../management/planning/rolePlanningReport.md)/[Feature](../management/planning/featurePlanningReport.md)/[Research](../engineering/practices/Research/Readme.md) Stories
        - [x] 12.1. Updated the refill workflow so requests go to the provider and required items are non-optional
        - [x] 12.2. Fixed text overflow handling so long descriptions cut off before breaking layout
        - [x] 12.3. Updated Gold certification report with badge, Silver, and Handshake appointment links
        - [x] 12.4. Finalized Week 12 role report closeout
        - [x] 12.5. Linked class and team meeting evidence for the submission
        - [x] 12.6. Verified all certification and meeting links resolve correctly
        - [x] 12.7. Prepared Week 13 carryover notes and next-step planning
        - [x] 12.8. Completed weekly status submission review
...
* [Role](../management/planning/rolePlanningReport.md)/[Feature](../management/planning/featurePlanningReport.md)/[Research](../engineering/practices/Research/Readme.md) Planned Next Week stories (5 pts - list of 5+)
    - Future [Role](../management/planning/rolePlanningReport.md)/[Feature](../management/planning/featurePlanningReport.md)/[Research](../engineering/practices/Research/Readme.md)
        - [ ] 13.1. Begin Week 13 ethics training work
        - [ ] 13.2. Keep documentation links and report references current
        - [ ] 13.3. Support final presentation preparation
        - [ ] 13.4. Track any carryover feedback from the team review
        - [ ] 13.5. Confirm final handoff items are complete before the semester wrap-up

        Where x is the week tasking.

### Weekly Summary
This week I closed out the two kanban items I completed: the refill workflow now reads as a provider-directed request with required items treated as non-optional, and the app text now has overflow protection so long descriptions cut off cleanly instead of breaking the layout. I also updated the Gold certification report with the Gold badge, Silver badge, and Handshake appointment links so the Week 12 submission is complete.
